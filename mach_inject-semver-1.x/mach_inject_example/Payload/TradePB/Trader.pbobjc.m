  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "code",
        .dataTypeSpecific.className = NULL,
        .number = PTMessage_FieldNumber_Code,
        .hasIndex = 7,
        .offset = (uint32_t)offsetof(PTMessage__storage_, code),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt32,
      },
      {
        .name = "message",
        .dataTypeSpecific.className = NULL,
        .number = PTMessage_FieldNumber_Message,
        .hasIndex = 8,
        .offset = (uint32_t)offsetof(PTMessage__storage_, message),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
    };
